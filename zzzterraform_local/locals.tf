locals {
  ...
  databricks_instance = "https://dbc-b53dc9b9-da2a.cloud.databricks.com/" # lookup(var.databricks_instances, var.environment)
  # # dbricks admin login
  ...
  # # databricks token
  databricks_token = "dapieceab6a17ad65bf5d9155e6f1f9abd7c" #lookup(var.databricks_tokens, var.environment)
  # deploy clusters
